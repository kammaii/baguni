...
public class LessonReview04 extends LessonInit implements LessonItem, LessonReview, Serializable {
    ...
    private String[] baseForm = {
            "아프다", "자다", "알다", "모르다", "쓰다", "가르치다", "만들다", "받다", "비가 내리다", "가져오다"
            , "내리다", "늦다", "듣다", "보내다", "괜찮다"};
    ...
    private String[][] conjugation = {
            ...
            {"써도", "써 봐요", "써 본 적 있어요", "쓰는 것 같아요", "쓸 것 같아요", "쓰세요", "써야 돼요", "써도 돼요"},
            {"가르쳐도", "가르쳐 봐요", "가르쳐 본 적 있어요", "가르치는 것 같아요", "가르칠 것 같아요", "가르치세요", "가르쳐야 돼요", "가르쳐도 돼요"},
            {"만들어도", "만들어 봐요", "만들어 본 적 있어요", "만드는 것 같아요", "만들 것 같아요", "만드세요", "만들어야 돼요", "만들어도 돼요"},
            {"받아도", "받아 봐요", "받아 본 적 있어요", "받는 것 같아요", "받을 것 같아요", "받으세요", "받아야 돼요", "받아도 돼요"},
            {"비가 내려도", "비가 내리는 것 같아요", "비가 내릴 것 같아요", "비가 내려야 돼요"},
            {"가져와도", "가져와 봐요", "가져와 본 적 있어요", "가져올 것 같아요", "가져오세요", "가져와야 돼요", "가져와도 돼요"},
            {"내릴 것 같아요", "내리세요", "내려야 돼요", "내려도 돼요"},
            {"늦어도", "늦는 것 같아요", "늦을 것 같아요", "늦어도 돼요"},
            {"들어도", "들어 봐요", "들어 본 적 있어요", "듣는 것 같아요", "들을 것 같아요", "들으세요", "들어야 돼요", "들어도 돼요"},
            {"보내도", "보내 봐요", "보내 본 적 있어요", "보내는 것 같아요", "보낼 것 같아요", "보내세요", "보내야 돼요", "보내도 돼요"},
