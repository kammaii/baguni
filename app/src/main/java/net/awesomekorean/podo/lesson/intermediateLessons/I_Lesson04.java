...
public class I_Lesson04 extends LessonInit_Lock implements I_Lesson, LessonItem, Serializable {
    ...
    private String[] dialogEng = {
            ...
            "Yes, here it is.",
            "Can I try it on?",
            "Yes, you can try it on over there.\n(after wearing) How is it?",
            "I'd like to take a look at the other one.",
            "Try this on as well.",
            "This is pretty. How much?",
            "It is 50,000 won.",
            "Can you give me a discount?",
            "OK. I’ll give you a discount since you speak Korean well. Give me 45,000 won only.",
            "Thank you!"
    };
