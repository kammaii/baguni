...
public class I_Lesson03 extends LessonInit_Lock implements I_Lesson, LessonItem, Serializable {
    ...
    private String[] dialogEng = {
            ...
            "This way please. This is very popular these days.",
            "Anything else?",
            "Well… This one is also good.",
            "Good. How much is it?",
            "It's 100,000 won. Would you like to take it?",
            "No thanks. I think it's a little expensive.",
            "Well, what about this one? The size is a little small, but the price is cheap.",
            "Great. I'll take it.",
            "Ok. Would you like anything else?",
            "I also need a sheet mask.",
            "The sheet mask is on this side.",
            "Ok, I will take it.",
            "Okay.",
